...
function ShowRoute(solveResult) {
	...
	directionsHeaderArray.push( headerstr);// + feature[service.FieldNames[0].FieldName]);
    ...
    directionsHeaderArray.push(dojo.byId("tdDirectionsListDirections" + routeLayer).innerHTML);
    dojo.byId("tdDirectionsListTime" + routeLayer).innerHTML = " Duration: " + FormatTime(routeDirections.totalTime);
    directionsHeaderArray.push(dojo.byId("tdDirectionsListTime" + routeLayer).innerHTML);
